...
sourceFiles.push(...['sonaloop/web/pages/hypotheses.py','sonaloop/web/pages/decisions.py','sonaloop/web/pages/councils.py','sonaloop/web/pages/surveys.py','sonaloop/web/_render.py','sonaloop/web/_presence.py','sonaloop/web/_primitive_taxonomy.py','sonaloop/web/_vm.py','sonaloop/web/ui.py','sonaloop/artifacts.py','sonaloop/suggestions/stance_scale.json'].map(file => resolve(repo,file)));
for (const file of sourceFiles.sort()) sources[relative(repo,file)] = sha(await readFile(file));
await mkdir(resource,{recursive:true});
for (const [family,fields] of [['notes',['title','text','kind']],['sections',['title','note','kind','member_ids','members']],['projects',['title','goal','description']],['search',['title','text']],['hypotheses',['text','status','prediction','result','drop_note','derived_from']],['decisions',['title','status','decision','based_on','rejected','superseded_by','supersedes']],['surveys',['title','intro','status','questions','response_count','responses','derived_from','survey_id','imported','total_responses']],['councils',['prompt','persona_ids','created_at','summary','exec_summary','proposal','selection_reason','statements','prompts','findings','claim_posture','head_to_head','red_team','personas','turns','votes']]]) {
