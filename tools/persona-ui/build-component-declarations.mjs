...
const labels = { questions: "Research questions", ideation: "HMW questions and attributed ideas", assessment: "Computed Plan assessment and supplied document", understanding: "Recorded Product Understanding", researchplan: "Research plans and recorded tasks", catalog: "Persona catalog and import provenance", chats: "Persona conversations and continuity proposals", records: "Persona records and sources", profiles: "Persona profiles and history", cohorts: "Cohort diagnostics", preparation: "Persona preparation", runs: 'Project Health and Run Diagnostics', memory: 'Memory and Recorded Experience', calendar: 'Recorded Calendar and Activities', plans: 'Recorded Plans', prototypes: 'Prototypes', references: 'Captured References', assets: 'Files and Evidence', notes: 'Notes', sections: 'Sections', projects: 'Projects', search: 'Search',
...
for (const [family, name] of Object.entries(labels)) {
  ...
  const disclosures = ['projects', 'runs', 'preparation', 'profiles', 'cohorts', 'records', 'chats', 'catalog', 'researchplan', 'understanding', 'assessment', 'ideation', 'questions'].includes(family);
