...
for (const [family, name] of Object.entries(labels)) {
  ...
  const disclosures = ['projects', 'runs', 'preparation', 'profiles', 'cohorts', 'records', 'chats', 'catalog', 'researchplan', 'understanding', 'assessment', 'ideation'].includes(family);
